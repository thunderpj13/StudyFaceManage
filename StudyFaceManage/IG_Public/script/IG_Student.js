      ...
      function initVue(){  
    		vm = new Vue({
    	                ...
    	                columns1: [
               {
    	                        ...
    	                        columns2: [
    	                                   {
    	                                    ...
    	                                    { title: '一卡通消费',  key: 'consumeTotal' ,
    	                                    	render: function (h, params) {	
    	                                    		if("undefined" == typeof params.row.consumeTotal) {
    	                                    			return  h('span', '0'+'(勤俭节约)');
    	                                    		}
    	                                    ...
    	                                    { title: '上课出勤',  key: 'attendanceTotal' ,
    	                                    	render: function (h, params) {	
    	                                    		if("undefined" == typeof params.row.attendanceTotal) {
    	                                    			return  h('span', '0'+'(有挂科的风险)');
    	                                    		}
    	                                    		...
    	                                    		if(attendanceTotal<=5){
    	                                           	...
    	                                           	}else if(attendanceTotal>=14&&attendanceTotal<=19){
    	                                    ...
    	                                    { title: '图书馆',  key: 'libraryTotal' ,
    	                                    	render: function (h, params) {	
    	                                    		if("undefined" == typeof params.row.libraryTotal) {
    	                                    			return  h('span', '0'+'(学习时间偏少)');
    	                                    		}
    	                                    ...
    	                                    { title: '成绩',  key: 'scoreTotal' ,
    	                                    	render: function (h, params) {	
    	                                    		if("undefined" == typeof params.row.scoreTotal) {
    	                                    			return  h('span', '0'+'(少挂科，多学习)');
    	                                    		}
    	        ...
    	        methods:{
   	        	...
   	        	udrawmodel:function(obj){
	        		...
	        		var cluster3 = obj[2];
	        		          ...
	        		          var schema = [
	        		                        {name: 'cost', index: 0, text: '一卡通自消费'},
	        		                        {name: 'attendence', index: 1, text: '上课出勤'},
	        		                        {name: 'library', index: 2, text: '图书馆'},
	        		                        {name: 'score', index: 3, text: '成绩'},
	        		                        {name: 'classes', index: 4, text: '分类'},
	        	...
	        	echarts.init(document.getElementById('myChart_kmeans')).setOption({
	        		color: [
 	        	   ...
 	        	   var current_stu = {};
 	            	...
 	            	$.ajax({
 	 	                  ...
 	 	                  success : function(data) { 
 	 	                	  debugger;
 	 	                	if(data.resultCode==200){
 	 	                	   vm.class_data = data.data;
 	 	  	                   
 	 	  	                   vm.classesModel = true;
 	 	                	}
    	  ...
    	  $.ajax({
                ...
                success:function(data) {    	                	  
                 if(data.resultCode==200){
              	 ...
              	 data.forEach(function(value,index){
              		 var modelObj=[]; 
              		 data[index].members.forEach(
              				 function(value,index){
              					 var pointObj = [];
              					 
              					 value.localArray.forEach(
              							 function(value, index) {
              								 pointObj.push(value);
              							 }
              					 );
              					 pointObj.push(value.clusterid);
              					 
              					 modelObj.push(pointObj);
              				 }
              		 );
              		 modeldata.push(modelObj);
              	 })
              	 vm.udrawmodel(modeldata);
              	 vm.kmeansModel=true;
                 }
                },
          	 });
