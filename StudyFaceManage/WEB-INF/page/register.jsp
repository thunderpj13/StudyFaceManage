...
<body class=" theme-blue" style="background:url(IG_Public/images/library.jpg);background-repeat: no-repeat;background-size: 100% 100%;background-attachment: fixed;">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form  name="form1"  method="post" id="reigsterForm">
                ...
                <div class="form-group">
                    <label>密码</label>
                    <input type="password" class="form-control span12" id="password"  name="password">
                </div>
                <div class="form-group">
                    <label>用户</label>
