    ...
    <div class="content">
      ...
      <div class="row">
								...
								<div class="col-lg-4">
								  ...
								  <button  class="btn btn-primary" style="margin:20px;" onclick="add()"><i class="fa fa-plus"></i>新增</button> 
								  <button  class="btn btn-primary"  onclick="graph()"><i class="fa fa-model"></i>查看聚类模型</button> 
								</div>
							</div>	
        ...
        <div class="contant" id="vueBox" v-cloak>
           ...
           <Modal v-model="detailModel" scrollable title="学生信息" @on-ok="save" >
                 ...
                 <Modal v-model="kmeansModel"  width="50%" scrollable title="学生聚类">
                 
                 <div id='myChart_kmeans' style='text-align:center;width:1000px;height:600px'></div>  
                 
                 </Modal>
                 
                 <Modal v-model="classesModel"  width="50%" scrollable title="聚类结果">
